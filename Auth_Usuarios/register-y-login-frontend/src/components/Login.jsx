...
/*Se tiene en cuenta los atributos que se manejan en el front*/
const Login = () => {
  ...
  /*Ahora se con el input se tiene en cuentas los atributos*/
  const { correo, contraseña } = inputs;

  /*Aqui se realiza un evento*/
  const HandleChange = (e) => {
    setInputs({ ...inputs, [e.target.name]: e.target.value });
  };
/*Se tiene en cuenta los eventos y con arreglos se muestran los mensajes segun la condicion*/
